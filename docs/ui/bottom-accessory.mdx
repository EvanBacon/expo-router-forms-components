...
The `Tabs.BottomAccessory` component allows you to render content below the tab bar. On iOS 26+, it uses the native tab bar accessory API. On Android and web, it provides a user-space implementation that positions content above the tab bar.
